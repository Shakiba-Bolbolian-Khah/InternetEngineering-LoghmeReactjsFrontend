...
class Cart extends React.Component {
    ...
    fetchCart(){
        ...
        fetch(`http://ie.etuts.ir:32120/Loghme/users/cart`, requestOptions)
        .then(response => {
    ...
    handleSubmit(event){
        ...
        fetch('http://ie.etuts.ir:32120/Loghme/users/finalize', requestOptions)
        .then((response) => {
    ...
    deleteFood(event, index){
        ...
        if(item.partyFood){
            fetch('http://ie.etuts.ir:32120/Loghme/foodparty', requestOptions)
            .then((response) => {
                if (response.ok) {
                    toast.dismiss(toastId)
